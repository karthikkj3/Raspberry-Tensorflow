# -*- coding: utf-8 -*-
"""
Created on Mon Jul 16 20:28:30 2018
...
def image_cnn_fn(features, labels, mode, params):
    num_classes = 2
    net = features["image"]

    net = tf.identity(net, name="input_tensor")
    
    net = tf.reshape(net, [-1, 750, 750, 3])    
...
model = tf.estimator.Estimator(model_fn=image_cnn_fn,
